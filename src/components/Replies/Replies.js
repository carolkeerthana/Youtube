...
const Replies = ({
  ...
  const toggleReplyDropdown = (replyIndex) => {
    if (editReplyIndex === null) {
      setReplyDropdownIndex(
        replyDropdownIndex === replyIndex ? null : replyIndex
      );
    }
  };
    ...
    <div>
      {replies.length > 0 && (
        ...
        >
          <FontAwesomeIcon
            icon={
              visibleReplies.includes(commentId) ? faChevronUp : faChevronDown
            }
          />{" "}
            ...
            <div key={reply.id} className="reply">
              ...
              <div className="reply-detail">
                <div className="reply-header">
                  <h3>
                    {reply.userId?.channelName || "Unknown User"}{" "}
                  ...
                  <div className="reply-actions">
                    ...
                    {isAuthenticated && replyDropdownIndex === replyIndex && (
                      <div className="dropdown-menu">
                        <button
                          onClick={() =>
                            handleEditReply(replyIndex, reply.text)
                          }
                        >
                          Edit
                        </button>
