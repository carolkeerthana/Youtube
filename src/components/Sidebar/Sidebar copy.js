...
const Sidebar = ({ sidebar, setSidebar, page, compactSidebar }) => {
  ...
  return (
    <>
      {isVideoPage && (
        <div
          className={`sidebar video-sidebar ${sidebar ? "" : "hidden-sidebar"}`}
          data-testid="sidebar"
        >
          ...
          <div className="shortcut-links">
            <Link to={"/"} className="linked-icons specific-link">
              <div
                className={`side-link ${activePage === "/" ? "active" : ""}`}
            ...
            <Link to={"/trending"} className="linked-icons specific-link">
              <div
                className={`side-link ${
                  activePage === "/trending" ? "active" : ""
                }`}
                onClick={() => handleActivePageClick("/trending")}
            ...
            <Link to="/subscriptions" className="linked-icons specific-link">
              <div
                ...
                onClick={(e) => handleProtectedLinkClick(e, "/subscriptions")}
            ...
            <div className="shortcut-links">
              ...
              <Link to="/history" className="linked-icons specific-link">
                <div
                  ...
                  onClick={(e) => handleProtectedLinkClick(e, "/history")}
              ...
              <Link to="/liked-videos" className="linked-icons specific-link">
                <div
                  className={`side-link ${
                    activePage === "/liked-videos" ? "active" : ""
                  }`}
                  onClick={(e) => handleProtectedLinkClick(e, "/liked-videos")}
                  data-testid="liked-videos-link"
                >
                  <img src={like} alt="" />
                  <p>Liked videos</p>
                </div>
          ...
          <div className="shortcut-links">
            ...
            <div
              className={`side-link ${
                activePage === "uTube Premium" ? "active" : ""
              }`}
              onClick={() => handleActivePageClick("uTube Premium")}
              data-testid="uTube-Premium-link"
            >
              <img src={youtube} alt="" />
              <p>UTube Premium</p>
            </div>
            <div
              className={`side-link ${activePage === "gaming" ? "active" : ""}`}
              onClick={() => handleActivePageClick("gaming")}
              data-testid="gaming-link"
            >
              <img src={gameIcon} alt="" />
              <p>Gaming</p>
            </div>
            <div
              className={`side-link ${activePage === "live" ? "active" : ""}`}
              onClick={() => handleActivePageClick("live")}
          ...
          <div className="shortcut-links">
            <div
              ...
              onClick={() => handleActivePageClick("settings")}
            ...
            <div
              className={`side-link ${
                activePage === "report history" ? "active" : ""
              }`}
              onClick={() => handleActivePageClick("report history")}
              data-testid="report-history-link"
            >
              <img src={report} alt="" />
              <p>Report History</p>
            </div>
            <div
              className={`side-link ${activePage === "help" ? "active" : ""}`}
              onClick={() => handleActivePageClick("help")}
            ...
            <div
              className={`side-link ${
                activePage === "send feedback" ? "active" : ""
              }`}
      ...
      {!isVideoPage && (
        <div
          className={`sidebar ${
            isSmallScreen ? "small-sidebar" : sidebar ? "" : "small-sidebar"
          }`}
          data-testid="sidebar"
        >
          <div className="shortcut-links">
              ...
              <div className="shortcut-links">
                ...
                <Link to="/liked-videos" className="linked-icons specific-link">
                  <div
                    ...
                    onClick={(e) =>
                      handleProtectedLinkClick(e, "/liked-videos")
                    }
                    data-testid="liked-videos-link"
                  >
                    <img src={like} alt="" />
